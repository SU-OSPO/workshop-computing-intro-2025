...
*Note: This task requires that you have conda installed already. Follow the instructions [here](../index.qmd) to do that if you have not done so already.*
...
Just as in any programming language, we can set variables in bash using the `=`
...
# 7. Variable Scope and Environment

Export to make variable available to child processes:
...
Controls where Bash searches for executables.
