...
subtitle: "Using `conda` and `mamba` to create environments and install packages."
order: 3
---
...
6. Activate `conda-test2` and run check versions to verify that you have the desired versions.
