...
I've hosted these data within a [fresh repository](https://github.com/SU-OSPO/penguins_repo) on GitHub. <kbd>Fork</kbd> this repository so that you have your own personal copy of it.
...
<img src="fig/https_clone.png" width="600"/>

Now, open GitHub Desktop, and select File > Clone Repository. Select URL, then paste the link you copied from GitHub. Choose a local path where you want to save the repository (GitHub will suggest a path for you), then click <kbd>Clone</kbd>. When prompted, indicate that you want to use this repo for your own purposes.
...
Now <kbd>Browse...</kbd> to select the new directory that you created with GitHub Desktop. Then <kbd>Create the Project</kbd>

::: {.callout-note}
In addition to using the git URL of the repository (e.g., https://github.com/willgearty/penguins_repo.git), you can also use the SSH link for more secure access and use of a repository. To learn more about securely creating and accessing github repositories see this [documentation](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens).
:::
