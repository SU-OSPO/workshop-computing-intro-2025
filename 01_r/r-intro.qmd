...
Once you've forked the repository, click on the green "Code" button, then click on "SSH" (since we set up SSH with our GitHub account in the [Git and GitHub lesson](../03_github/index.qmd)). Then copy the SSH link of the repo:
