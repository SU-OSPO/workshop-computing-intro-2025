...
1.  Save the changes, then commit them to the dev1 branch on your local repo using GitHub Desktop.
...
1.  Clicking "Create Pull Request" or clicking the green "Compare & pull request" will open the "pull request" page on github.com in your web browser. Open the pull request by clicking on either button.
...
1.  Let's merge your pull request. There's a green `Merge pull request` button at the bottom of the page. There's also a drop down arrow next to it. If you click that, you will see Merge, Squash & Merge, and Rebase options, just as we did when merging branches in GitHub Desktop in [Exercise 1](exercise1.qmd).
