...
This appendix repeats exercises 1-3 but using the command-line interface (CLI)
for `git` rather than GitHub Desktop. While GitHub Desktop provides most of the
functionality that you need to develop with git/GitHub, the CLI provides a more
powerful, fine-grained control of `git`. Users accustomed to using a terminal
may also find the CLI to be more efficient to work with.
